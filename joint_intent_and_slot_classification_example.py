...
os.system("unzip ./NLU-Evaluation-Data-master.zip -d .")

# convert the dataset to the NeMo format
os.system("python ./import_datasets.py --dataset_name=assistant --source_data_dir=./NLU-Evaluation-Data-master --target_data_dir=./nemo_format")
...
os.system("ls -l ./NLU-Evaluation-Data-master/dataset/trainset")

# print all intents from the NeMo format intent dictionary
os.system("echo 'Intents: ' $(wc -l < ./nemo_format/dict.intents.csv)")
os.system("cat ./nemo_format/dict.intents.csv")

# print all slots from the NeMo format slot dictionary
os.system("echo 'Slots: ' $(wc -l < ./nemo_format/dict.slots.csv)")
os.system("cat ./nemo_format/dict.slots.csv")

# examples from the intent training file
os.system("head -n 10 ./nemo_format/train.tsv")

# examples from the slot training file
os.system("head -n 10 ./nemo_format/train_slots.tsv")
